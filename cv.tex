...
\workitem
{Media and Graphics Interdisciplinary Centre. UBC.}%Company
{2010--Present}%Dates
...
{Created a novel development framework for prototyping UbiComp applications}%Achievement(1)
{Successfully led several developer teams creating middleware, web mobile and embedded applications}%Achievement(2)
{Produced high quality HCI research leading to successful publications}%Achievement(3)
